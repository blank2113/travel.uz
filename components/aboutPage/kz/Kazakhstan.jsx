...
import {getItemValueK} from '@/store/slice/filterSlice'
...
const Kazakhstan = () => {
  ...
  const filterItem = useSelector((state) => state.filterSlice.valueK);
  const itemValueK = useSelector((state) => state.filterSlice.itemValueK);
  return (
    <div>
      <p className={classes.text}>
        Отправляйтесь в настоящее приключение вместе с Minzifa Travel! Сказочные
        природные пейзажи, невероятно вкусная национальная еда, добродушные
        жители и захватывающая история. И все это он – Казахстан!
      </p>
      <p className={classes.text}>
        ...
        религиозных течений, которые и делают ее уникальной и вместе с тем такой
        похожей на все самое любимое и родное.
      </p>
      <p className={classes.text}>
        Казахстан – это страна свободолюбивых и гордых людей, которые всегда
        рады туристам со всего мира. Впитайте остроту вкусов и яркость красок, а
        Minzifa Travel сделает каждый ваш день в этой удивительной стране
        незабываемым!
      </p>
      ...
      <p className={classes.text}>
        ...
        погоду. Выбирать время для путешествия, необходимо отталкиваясь от того,
        чем именно хотелось бы заняться в отпуске. Собираетесь в азиатскую
        страну:
      </p>
      <div>
        <li>
          весной? Готовьтесь увидеть цветущие луга и заснеженные вершины. Это
          отличное время для походов по каньонам и неспешных прогулок по городу.
          Холода остались позади, а до известной казахской жары еще есть время –
          лучшей поры для знакомства с достопримечательностями и не придумать!
        </li>
        <li>
          ...
          чудесный номер в отеле. Во-вторых, на севере страны все же достаточно
          умеренный климат. А потому можно смело прогуляться по национальным
          паркам или насладиться водными процедурами. А в-третьих, жаркий
          Казахстан – это классика, с которой хоть раз в жизни должен
          познакомиться каждый отдыхающий!
        </li>
        <li>
          ...
          фотосессий! Осенние пейзажи Казахстана не могут оставить равнодушными,
          и приятная погода располагает к долгим прогулкам. В это время рынки
          заполняются свежими фруктами и овощами, поэтому уехать без урожая
          точно не получится!
        </li>
        <li>
          зимой? Лыжи, сноуборд, коньки: Казахстан прекрасно подходит для
          горнолыжного отдыха. Если к активностям вы равнодушны, можно пройтись
          по музеям или посетить баню.
        </li>
      </div>
      <p className={classes.text}>
      ...
      <p className={classes.text}>
        ...
        Полюбуйтесь крупнейшей в Центральной Азии мечетью с высокими минаретами
        – Хазрет Султан. Загляните в самый большой шатер мира и по
      ...
      <p className={classes.text}>
        Если вы хотите узнать больше об истории казахского народа, то вам сюда.
        Туркестан, Отрар, Сайрам – мечети и мавзолеи в этих городах могут
        рассказать много интересного о тайнах и культуре кочевого народа.
      </p>
      <p className={classes.text}>
        Казахстан – удивительная страна, и мы будем рады сопровождать вас на
        всех этапах вашего с ней знакомства. С Minzifa Travel путешествие станет
        увлекательнее, безопаснее и ярче! Обращайтесь с любыми вопросами в
      ...
      <div className={classes.cities}>
        ...
        <div className={classes.countries}>
          {countries
            ...
            .map((el) =>
              el.cities.map((item) => <CountryCard key={item.id} item={item} />)
            )}
        </div>
      </div>
      <div className={classes.tours_wrapper}>
        ...
        <div className={classes.tours_content}>
          {itemValueK !== "Все туры"
            ? tours.filter(item => item.country === 'Казахстан')
